...
<br/>
	...
	<?php
		...
		$brg=sqlsrv_query($kon, "select  a.*, b.nama_karyawan, b.nama_jabatan, b.nama_depo AS dp, c.desc_cc from perangkat_it a left join karyawan_perangkat_it b ON a.nik_karyawan = b.nik_karyawan LEFT JOIN cost_center c ON a.cost_center = c.id_cc where a.nama_region = '".$uu['nama_region']."'  AND a.status = '1' ORDER BY a.no_aset ASC ");
	...
	while($b=sqlsrv_fetch_array($brg)){
		...
		<tr>
			...
			<td>
				...
				<a href="pindah_user_responsible.php?no_aset=<?php echo $b['no_aset'];?>&nik_karyawan=<?php echo $b['nik_karyawan'];?>&uname=<?php echo $_SESSION['uname'];?>"  data-toggle="tooltip" title="Pindahkan Sesuai User Responsible" data-placement="top"><span class="glyphicon glyphicon-transfer"></span></a>
			</td>
      <td>
			...
			<div class="modal-header">
				...
				<h4 class="modal-title">Tambah Perangkat
				 ...
				 <div class="modal-body">
					<form name="myForm" action="tambah_perangkat_it.php" onsubmit="return validateForm()" method="post">

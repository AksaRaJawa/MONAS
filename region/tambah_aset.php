...
/*$cek2 = "select * from asset where nik_karyawan = '".$nik_karyawan."' AND nik_karyawan != ' ' ";
...
'".$status_device."','".$id_device."','".$masa_berlaku."','".$depo[0]."','".$nama_region."','".$keterangan."','".$status."','".$uname."','".$status_validasi."','".$provider."','".$nohp."','".$tggl_aktif."')");
if($nik_karyawan != '')
{
sqlsrv_query($kon, "insert into karyawan values ('".$nik_karyawan."','".$nama_karyawan."','".$nama_jabatan."','".$depo[0]."','".$nama_region."','".$status."')");
}

...
<div class="col-md-10">
<button onclick="document.location='lap_pindahan_perangkat_it.php'" class="btn btn-success col-md-2"><span class="glyphicon glyphicon-paperclip"></span>&nbsp;Exsport ke Excel</button>
</div>

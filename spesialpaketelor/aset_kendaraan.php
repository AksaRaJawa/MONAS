...
<div class="col-md-10">
<button onclick="location.href='import_aset_kendaraan.php?uname=<?php echo $_SESSION['uname'];?>'" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-paperclip"></span>&nbsp;Import dari Excel</button>
...
<tbody >
    ...
    $status = $b['status'];
      ...
      <td>
				...
				<a href="status_aset_kendaraan.php?id=<?php echo $b['no_aset_kendaraan']; ?>" name="status" class="btn btn-plus"><?php if($status=='1'){ echo "Non-Aktifkan"; }else if($status=='0'){ echo "Aktifkan";}?></a>
			</td>
		</tr>

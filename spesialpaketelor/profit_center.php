...
<div class="col-md-10">
<button onclick="document.location='import_profit_center.php'" class="btn btn-info col-md-2"><span class="glyphicon glyphicon-paperclip"></span>&nbsp;Import dari Excel</button>

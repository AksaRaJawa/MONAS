...
?>
        <div class="modal-header">
          ...
          <table class="table table-hover table-nomargin table-nobordered">
        	...
        	<tbody>
        		<tr>
        			<td></td><td><?php echo "<img src='../spesialpaketelor/gambar_aset_it/".$b['foto']."' width:'30px' height:'30px'/>"?></td>
        		</tr>
            <tr style="color:black" >
        			<td> No Aset </td><td><?php echo $id?> <a href="" name="status" class="btn btn-plus"><?php if($b['status']=='1'){ echo " "; }else if($b['status']=='0'){ echo "Scrapped";}?></a></td>
        		</tr>
            <tr style="color:black" >

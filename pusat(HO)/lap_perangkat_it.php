...
$SI->setCellValue('A1', 'DATA PERANGKAT IT HO AND ALL REGION == SNS'); //Judul laporan
...
$strsql	= "SELECT a.*, b.person_responsible from perangkat_it a LEFT JOIN cost_center b ON a.cost_center = b.id_cc ORDER BY a.nama_region";

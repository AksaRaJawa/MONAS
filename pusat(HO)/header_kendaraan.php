...
<body>
	...
	<div class="col-md-2">
		...
		<ul class="nav nav-pills nav-stacked" >
			...
			<li><a href="asuransi.php"><span class="glyphicon glyphicon-tags"></span>  Asuransi Kendaraan</a></li>
			<li><a href="histori_aset_kendaraan.php"><span class="glyphicon glyphicon-refresh"></span>  Log History</a></li>
			<li><a href="pindahan_aset_kendaraan.php"><span class="glyphicon glyphicon-refresh"></span>  Log Mutasi</a></li>
			<li><a href="histori_asuransi.php"><span class="glyphicon glyphicon-refresh"></span>  Log Asuransi </a></li>

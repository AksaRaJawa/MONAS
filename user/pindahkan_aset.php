...
$sql = sqlsrv_query($kon, "update asset set no_imei = '".$no_imei."', nik_karyawan = '".$karyawan[0]."', id_depo = '".$id_depo."', nama_region = '".$nama_region."', uname = '".$uname."' where id_asset='".$id_asset."'");

$sqlsave = sqlsrv_query($kon, "insert into pindahan values ('$no_imei','$nama_merk','$nama_tipe','$no_asset','$nik_dulu','$nama_dulu','$depo_dulu','".$karyawan[0]."','".$karyawan[2]."','".$nama_depo."','$uname','$tanggal_perubahan','$waktu')");

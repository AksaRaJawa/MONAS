...
if(isset($_GET['pesan'])){
	...
	if($pesan=="gagal"){
		...
		echo "<div class='alert alert-success'>Password anda telah berubah  !! Terimakasih </div>";
...
<div class="col-md-5 col-md-offset-3">
	<form action="ganti_pass_act.php" method="post">
		...
		<div class="form-group">
			...
			<p class="help-block"> Jika lupa password lama anda. Silahkan hubungi IT HO. Terimakasih. </p>
		</div>
		<div class="form-group">

...
{
	echo"<script>alert('MAAF --- UNTUK NAMA MERK SAMSUNG TIDAK AKAN DIRUBAH !!!')</script>";
	...
	status_device = '".$status_device."', tanggal_terima = '".$tanggal_terima."', keterangan = '".$keterangan."', provider = '".$provider."', nohp = '".$nohp."', uname = '".$uname."' where id_asset='".$id_asset."'");

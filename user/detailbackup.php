...
?>
				...
				<h4 class="modal-title">Data Aset Modis Backup <?=$dp['nama_depo']?>
				</div>
				<div class="modal-body">				
					<?php
						
						$jumlah_record1=sqlsrv_query($kon, "SELECT COUNT(*) AS jumlah from asset where id_depo = '".$id."' AND status_device = 'Backup' ", $param, $option);
	...
	<?php 
		...
		WHERE a.id_depo = '".$id."' AND a.status_device = 'Backup'");
	    $nox=1;

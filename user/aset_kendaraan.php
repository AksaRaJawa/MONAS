...
<tbody >
	<?php
		...
		$brg=sqlsrv_query($kon, "select a.*, b.nama_karyawan, b.nama_jabatan, b.nama_depo from kendaraan_asetkendaraan a LEFT JOIN karyawan_perangkat_it b ON a.nik_baru = b.nik_karyawan where a.nama_depo_kendaraan = '".$uu['nama_depo']."'");

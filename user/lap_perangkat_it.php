...
$SI->setCellValue('A1', 'DATA PERANGKAT IT : '.$depo); //Judul laporan
...
$strsql	= "SELECT a.*, b.person_responsible from perangkat_it a LEFT JOIN cost_center b ON a.cost_center = b.id_cc WHERE a.nama_depo = '".$depo."' ";
